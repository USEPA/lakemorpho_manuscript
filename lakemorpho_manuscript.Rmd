...
A common application of `lakemorpho` is to calculate the full suite of lake metrics for multiple lakes.  This use case demonstrates how to do that with a commonly encountered GIS data file, the shapefile.  

## Read in data

## Loop through lakes with purrr and calc metrics

## Add metrics back to original shapefile
