...
\begin{frame}
  \begin{tikzpicture}[scale = 0.6]
    ...
    \draw[thick] (10, 2) ellipse (2.3cm and 1.6cm);
    \node[align=left] at (10, 2) {\small lakeMaxLength \\ \tiny (addLine = T)};
    
    \draw[>=stealth, ->, line width = 0.2mm] (12.32, 2) -- (13,2)-- (13, 4) -- (14, 4);
    \node[align = left] at (12.8, 5) {addLine \\  TRUE};
    
    \draw[>=stealth, ->, line width = 0.2mm] (12.32, 2) -- (13,2) -- (13, 0) -- (14, 0);
